...
describe('CommandeClient Service', () => {
  ...
  beforeEach(() => {
    ...
    elemDefault = {
      id: 0,
      cmdIdenCl: 0,
      cmdDateEffetCl: currentDate,
      cmdDateLivraisonCl: currentDate,
    };
  });
  ...
  describe('Service methods', () => {
    it('should find an element', () => {
      const returnedFromService = Object.assign(
        {
          cmdDateEffetCl: currentDate.format(DATE_FORMAT),
          cmdDateLivraisonCl: currentDate.format(DATE_FORMAT),
        },
        elemDefault
      );
    ...
    describe('addCommandeClientToCollectionIfMissing', () => {
      ...
      it('should add only unique CommandeClient to an array', () => {
        const commandeClientArray: ICommandeClient[] = [{ id: 123 }, { id: 456 }, { id: 36687 }];
