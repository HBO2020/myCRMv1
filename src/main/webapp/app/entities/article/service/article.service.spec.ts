...
describe('Article Service', () => {
  ...
  beforeEach(() => {
    ...
    elemDefault = {
      id: 0,
      artclIden: 0,
      artclReference: 'AAAAAAA',
      artclDesignation: 'AAAAAAA',
      artclQnStock: 0,
      artclImgContentType: 'image/png',
      artclImg: 'AAAAAAA',
      artclSerie: 'AAAAAAA',
      artclPrixAchat: 0,
      artclPxAchatTotal: 0,
  ...
  describe('Service methods', () => {
      ...
      const returnedFromService = Object.assign(
        {
          id: 1,
          artclIden: 1,
          artclReference: 'BBBBBB',
          artclDesignation: 'BBBBBB',
          artclQnStock: 1,
          artclImg: 'BBBBBB',
          artclSerie: 'BBBBBB',
          artclPrixAchat: 1,
    ...
    describe('addArticleToCollectionIfMissing', () => {
      ...
      it('should add only unique Article to an array', () => {
        const articleArray: IArticle[] = [{ id: 123 }, { id: 456 }, { id: 9546 }];
