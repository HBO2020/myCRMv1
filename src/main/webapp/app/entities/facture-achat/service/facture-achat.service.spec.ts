...
describe('FactureAchat Service', () => {
  ...
  beforeEach(() => {
    ...
    elemDefault = {
      id: 0,
      achatIdentFac: 0,
      achatDateEffet: currentDate,
      achatDateUpdate: currentDate,
      achatStatusFact: 'AAAAAAA',
      achatMontantHT: 0,
      achatMontantTVA: 0,
      achatMontantTTC: 0,
    };
  ...
  describe('Service methods', () => {
    it('should find an element', () => {
      const returnedFromService = Object.assign(
        {
          achatDateEffet: currentDate.format(DATE_FORMAT),
          achatDateUpdate: currentDate.format(DATE_FORMAT),
        },
        elemDefault
      );
