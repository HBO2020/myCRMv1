...
describe('FactureVente Service', () => {
  ...
  beforeEach(() => {
    ...
    elemDefault = {
      id: 0,
      venteIdentFac: 0,
      venteDateEffet: currentDate,
      venteDateUpdate: currentDate,
      venteStatusFact: 'AAAAAAA',
      venteMontantHT: 0,
      venteMontantTVA: 0,
      venteMontantTTC: 0,
    };
  ...
  describe('Service methods', () => {
    it('should find an element', () => {
      const returnedFromService = Object.assign(
        {
          venteDateEffet: currentDate.format(DATE_FORMAT),
          venteDateUpdate: currentDate.format(DATE_FORMAT),
        },
        elemDefault
      );
