...
describe('Client Service', () => {
  ...
  beforeEach(() => {
    ...
    elemDefault = {
      id: 0,
      clIdent: 0,
      clRaisonSocial: 'AAAAAAA',
      clAdresse: 'AAAAAAA',
      clCodePostal: 'AAAAAAA',
      clVille: 'AAAAAAA',
      clCountry: 'AAAAAAA',
      clEmail: 'AAAAAAA',
      clNumeroMobile: 'AAAAAAA',
      clNumeroFax: 'AAAAAAA',
      clNumeroFixe: 'AAAAAAA',
      clDateCreation: currentDate,
      clDateUpdate: currentDate,
      clStatus: 'AAAAAAA',
      clNumeroSiret: 'AAAAAAA',
    };
  });
  ...
  describe('Service methods', () => {
    it('should find an element', () => {
      const returnedFromService = Object.assign(
        {
          clDateCreation: currentDate.format(DATE_FORMAT),
          clDateUpdate: currentDate.format(DATE_FORMAT),
        },
        elemDefault
      );
      ...
      const returnedFromService = Object.assign(
        {
          id: 1,
          clIdent: 1,
          clRaisonSocial: 'BBBBBB',
          clAdresse: 'BBBBBB',
          clCodePostal: 'BBBBBB',
          clVille: 'BBBBBB',
          clCountry: 'BBBBBB',
          clEmail: 'BBBBBB',
          clNumeroMobile: 'BBBBBB',
          clNumeroFax: 'BBBBBB',
          clNumeroFixe: 'BBBBBB',
          clDateCreation: currentDate.format(DATE_FORMAT),
          clDateUpdate: currentDate.format(DATE_FORMAT),
          clStatus: 'BBBBBB',
          clNumeroSiret: 'BBBBBB',
        },
        elemDefault
      );
    ...
    describe('addClientToCollectionIfMissing', () => {
      ...
      it('should add only unique Client to an array', () => {
        const clientArray: IClient[] = [{ id: 123 }, { id: 456 }, { id: 32371 }];
