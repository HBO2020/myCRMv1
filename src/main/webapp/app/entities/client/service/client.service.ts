...
export class ClientService {
  ...
  protected convertDateFromClient(client: IClient): IClient {
    return Object.assign({}, client, {
      clDateCreation: client.clDateCreation?.isValid() ? client.clDateCreation.format(DATE_FORMAT) : undefined,
      clDateUpdate: client.clDateUpdate?.isValid() ? client.clDateUpdate.format(DATE_FORMAT) : undefined,
    });
  }

  protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
    if (res.body) {
      res.body.clDateCreation = res.body.clDateCreation ? dayjs(res.body.clDateCreation) : undefined;
      res.body.clDateUpdate = res.body.clDateUpdate ? dayjs(res.body.clDateUpdate) : undefined;
    }
    return res;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((client: IClient) => {
        client.clDateCreation = client.clDateCreation ? dayjs(client.clDateCreation) : undefined;
        client.clDateUpdate = client.clDateUpdate ? dayjs(client.clDateUpdate) : undefined;
      });
    }
    return res;
  }
