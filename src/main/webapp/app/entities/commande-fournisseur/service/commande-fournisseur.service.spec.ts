...
describe('CommandeFournisseur Service', () => {
  ...
  beforeEach(() => {
    ...
    elemDefault = {
      id: 0,
      cmdIdenFr: 0,
      cmdDateEffetFr: currentDate,
      cmdDateLivraisonFr: currentDate,
    };
  });
  ...
  describe('Service methods', () => {
    it('should find an element', () => {
      const returnedFromService = Object.assign(
        {
          cmdDateEffetFr: currentDate.format(DATE_FORMAT),
          cmdDateLivraisonFr: currentDate.format(DATE_FORMAT),
        },
        elemDefault
      );
    ...
    describe('addCommandeFournisseurToCollectionIfMissing', () => {
      ...
      it('should add only unique CommandeFournisseur to an array', () => {
        const commandeFournisseurArray: ICommandeFournisseur[] = [{ id: 123 }, { id: 456 }, { id: 98521 }];
