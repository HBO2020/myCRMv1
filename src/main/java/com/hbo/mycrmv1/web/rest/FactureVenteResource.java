...
/**
 * REST controller for managing {@link com.hbo.mycrmv1.domain.FactureVente}.
 */
@RestController
@RequestMapping("/api")
public class FactureVenteResource {
    ...
    public ResponseEntity<FactureVente> createFactureVente(@RequestBody FactureVente factureVente) throws URISyntaxException {
    ...
    public ResponseEntity<FactureVente> updateFactureVente(
        ...
        @RequestBody FactureVente factureVente
    ...
    public List<FactureVente> getAllFactureVentes() {
        ...
        return factureVenteService.findAll();
    }
