...
/**
 * REST controller for managing {@link com.hbo.mycrmv1.domain.Catalogue}.
 */
@RestController
@RequestMapping("/api")
public class CatalogueResource {
    ...
    public List<Catalogue> getAllCatalogues(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
