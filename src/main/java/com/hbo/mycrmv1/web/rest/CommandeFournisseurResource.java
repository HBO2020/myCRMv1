...
/**
 * REST controller for managing {@link com.hbo.mycrmv1.domain.CommandeFournisseur}.
 */
@RestController
@RequestMapping("/api")
public class CommandeFournisseurResource {
    ...
    public ResponseEntity<CommandeFournisseur> createCommandeFournisseur(@RequestBody CommandeFournisseur commandeFournisseur)
        ...
        CommandeFournisseur result = commandeFournisseurService.save(commandeFournisseur);
    ...
    public ResponseEntity<CommandeFournisseur> partialUpdateCommandeFournisseur(
        ...
        Optional<CommandeFournisseur> result = commandeFournisseurService.partialUpdate(commandeFournisseur);
    ...
    public ResponseEntity<CommandeFournisseur> getCommandeFournisseur(@PathVariable Long id) {
        ...
        Optional<CommandeFournisseur> commandeFournisseur = commandeFournisseurService.findOne(id);
