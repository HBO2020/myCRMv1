...
class CommandeClientResourceIT {
    ...
    private static final Integer DEFAULT_CMD_IDEN_CL = 1;
    private static final Integer UPDATED_CMD_IDEN_CL = 2;

    private static final LocalDate DEFAULT_CMD_DATE_EFFET_CL = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_CMD_DATE_EFFET_CL = LocalDate.now(ZoneId.systemDefault());

    private static final LocalDate DEFAULT_CMD_DATE_LIVRAISON_CL = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_CMD_DATE_LIVRAISON_CL = LocalDate.now(ZoneId.systemDefault());
    ...
    public static CommandeClient createEntity(EntityManager em) {
        CommandeClient commandeClient = new CommandeClient()
            .cmdIdenCl(DEFAULT_CMD_IDEN_CL)
            .cmdDateEffetCl(DEFAULT_CMD_DATE_EFFET_CL)
            .cmdDateLivraisonCl(DEFAULT_CMD_DATE_LIVRAISON_CL);
    ...
    public static CommandeClient createUpdatedEntity(EntityManager em) {
        CommandeClient commandeClient = new CommandeClient()
            .cmdIdenCl(UPDATED_CMD_IDEN_CL)
            .cmdDateEffetCl(UPDATED_CMD_DATE_EFFET_CL)
            .cmdDateLivraisonCl(UPDATED_CMD_DATE_LIVRAISON_CL);
        return commandeClient;
    }
    ...
    void createCommandeClient() throws Exception {
        ...
        assertThat(testCommandeClient.getCmdIdenCl()).isEqualTo(DEFAULT_CMD_IDEN_CL);
        assertThat(testCommandeClient.getCmdDateEffetCl()).isEqualTo(DEFAULT_CMD_DATE_EFFET_CL);
        assertThat(testCommandeClient.getCmdDateLivraisonCl()).isEqualTo(DEFAULT_CMD_DATE_LIVRAISON_CL);
    }
    ...
    void getAllCommandeClients() throws Exception {
        ...
        restCommandeClientMockMvc
            ...
            .andExpect(jsonPath("$.[*].cmdIdenCl").value(hasItem(DEFAULT_CMD_IDEN_CL)))
            .andExpect(jsonPath("$.[*].cmdDateEffetCl").value(hasItem(DEFAULT_CMD_DATE_EFFET_CL.toString())))
            .andExpect(jsonPath("$.[*].cmdDateLivraisonCl").value(hasItem(DEFAULT_CMD_DATE_LIVRAISON_CL.toString())));
    }
    ...
    void getCommandeClient() throws Exception {
        ...
        restCommandeClientMockMvc
            ...
            .andExpect(jsonPath("$.cmdIdenCl").value(DEFAULT_CMD_IDEN_CL))
            .andExpect(jsonPath("$.cmdDateEffetCl").value(DEFAULT_CMD_DATE_EFFET_CL.toString()))
            .andExpect(jsonPath("$.cmdDateLivraisonCl").value(DEFAULT_CMD_DATE_LIVRAISON_CL.toString()));
    }
    ...
    void putNewCommandeClient() throws Exception {
        ...
        CommandeClient testCommandeClient = commandeClientList.get(commandeClientList.size() - 1);
        assertThat(testCommandeClient.getCmdIdenCl()).isEqualTo(UPDATED_CMD_IDEN_CL);
        assertThat(testCommandeClient.getCmdDateEffetCl()).isEqualTo(UPDATED_CMD_DATE_EFFET_CL);
        assertThat(testCommandeClient.getCmdDateLivraisonCl()).isEqualTo(UPDATED_CMD_DATE_LIVRAISON_CL);
    }
    ...
    void partialUpdateCommandeClientWithPatch() throws Exception {
        ...
        partialUpdatedCommandeClient.cmdDateLivraisonCl(UPDATED_CMD_DATE_LIVRAISON_CL);
