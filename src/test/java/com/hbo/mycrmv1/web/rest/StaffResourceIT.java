...
import com.hbo.mycrmv1.repository.StaffRepository;
...
class StaffResourceIT {
    ...
    private static final String DEFAULT_ID_STAFF = "AAAAAAAAAA";
    private static final String UPDATED_ID_STAFF = "BBBBBBBBBB";
    ...
    public static Staff createEntity(EntityManager em) {
        Staff staff = new Staff().idStaff(DEFAULT_ID_STAFF).password(DEFAULT_PASSWORD);
        return staff;
    }
    ...
    public static Staff createUpdatedEntity(EntityManager em) {
        Staff staff = new Staff().idStaff(UPDATED_ID_STAFF).password(UPDATED_PASSWORD);
        return staff;
    }
    ...
    void createStaff() throws Exception {
        ...
        assertThat(testStaff.getIdStaff()).isEqualTo(DEFAULT_ID_STAFF);
    ...
    void getAllStaff() throws Exception {
        ...
        restStaffMockMvc
            ...
            .andExpect(jsonPath("$.[*].idStaff").value(hasItem(DEFAULT_ID_STAFF)))
    ...
    void getStaff() throws Exception {
        ...
        restStaffMockMvc
            ...
            .andExpect(jsonPath("$.idStaff").value(DEFAULT_ID_STAFF))
    ...
    void putNewStaff() throws Exception {
        ...
        updatedStaff.idStaff(UPDATED_ID_STAFF).password(UPDATED_PASSWORD);
        ...
        Staff testStaff = staffList.get(staffList.size() - 1);
        assertThat(testStaff.getIdStaff()).isEqualTo(UPDATED_ID_STAFF);
    ...
    void partialUpdateStaffWithPatch() throws Exception {
        ...
        partialUpdatedStaff.password(UPDATED_PASSWORD);
    ...
    void fullUpdateStaffWithPatch() throws Exception {
        ...
        partialUpdatedStaff.idStaff(UPDATED_ID_STAFF).password(UPDATED_PASSWORD);
