...
class CategoryResourceIT {
    ...
    private static final String DEFAULT_CATEGORY_DESCIPTION = "AAAAAAAAAA";
    private static final String UPDATED_CATEGORY_DESCIPTION = "BBBBBBBBBB";
    ...
    public static Category createEntity(EntityManager em) {
        Category category = new Category().categoryName(DEFAULT_CATEGORY_NAME).categoryDesciption(DEFAULT_CATEGORY_DESCIPTION);
        return category;
    }
    ...
    public static Category createUpdatedEntity(EntityManager em) {
        Category category = new Category().categoryName(UPDATED_CATEGORY_NAME).categoryDesciption(UPDATED_CATEGORY_DESCIPTION);
        return category;
    }
    ...
    void createCategory() throws Exception {
        ...
        assertThat(testCategory.getCategoryDesciption()).isEqualTo(DEFAULT_CATEGORY_DESCIPTION);
    }
    ...
    void getAllCategories() throws Exception {
        ...
        restCategoryMockMvc
            ...
            .andExpect(jsonPath("$.[*].categoryDesciption").value(hasItem(DEFAULT_CATEGORY_DESCIPTION)));
    }
    ...
    void getCategory() throws Exception {
        ...
        restCategoryMockMvc
            ...
            .andExpect(jsonPath("$.categoryDesciption").value(DEFAULT_CATEGORY_DESCIPTION));
    }
    ...
    void putNewCategory() throws Exception {
        ...
        updatedCategory.categoryName(UPDATED_CATEGORY_NAME).categoryDesciption(UPDATED_CATEGORY_DESCIPTION);
        ...
        assertThat(testCategory.getCategoryDesciption()).isEqualTo(UPDATED_CATEGORY_DESCIPTION);
    }
    ...
    void fullUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.categoryName(UPDATED_CATEGORY_NAME).categoryDesciption(UPDATED_CATEGORY_DESCIPTION);
