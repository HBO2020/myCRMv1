...
describe('Client e2e test', () => {
  ...
  it('should load Clients', async () => {
    ...
    expect(await clientComponentsPage.getTitle()).to.eq('myCrMv1App.client.home.title');
  ...
  it('should load create Client page', async () => {
    ...
    expect(await clientUpdatePage.getPageTitle()).to.eq('myCrMv1App.client.home.createOrEditLabel');
  ...
  it('should create and save Clients', async () => {
    ...
    await promise.all([
      clientUpdatePage.setClIdentInput('5'),
      clientUpdatePage.setClRaisonSocialInput('clRaisonSocial'),
      clientUpdatePage.setClAdresseInput('clAdresse'),
      clientUpdatePage.setClCodePostalInput('clCodePostal'),
      clientUpdatePage.setClVilleInput('clVille'),
      clientUpdatePage.setClCountryInput('clCountry'),
      clientUpdatePage.setClEmailInput('clEmail'),
      clientUpdatePage.setClNumeroMobileInput('clNumeroMobile'),
      clientUpdatePage.setClNumeroFaxInput('clNumeroFax'),
      clientUpdatePage.setClNumeroFixeInput('clNumeroFixe'),
      clientUpdatePage.setClDateCreationInput('2000-12-31'),
      clientUpdatePage.setClDateUpdateInput('2000-12-31'),
      clientUpdatePage.setClStatusInput('clStatus'),
      clientUpdatePage.setClNumeroSiretInput('clNumeroSiret'),
      clientUpdatePage.civiliteclSelectLastOption(),
    ]);
  ...
  it('should delete last Client', async () => {
    ...
    expect(await clientDeleteDialog.getDialogTitle()).to.eq('myCrMv1App.client.delete.question');
