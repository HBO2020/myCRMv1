...
describe('Category e2e test', () => {
  ...
  it('should load Categories', async () => {
    ...
    expect(await categoryComponentsPage.getTitle()).to.eq('myCrMv1App.category.home.title');
  ...
  it('should load create Category page', async () => {
    ...
    expect(await categoryUpdatePage.getPageTitle()).to.eq('myCrMv1App.category.home.createOrEditLabel');
  ...
  it('should create and save Categories', async () => {
    ...
    await promise.all([
      ...
      categoryUpdatePage.setCategoryDesciptionInput('categoryDesciption'),
    ]);
  ...
  it('should delete last Category', async () => {
    ...
    expect(await categoryDeleteDialog.getDialogTitle()).to.eq('myCrMv1App.category.delete.question');
