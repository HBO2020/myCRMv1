...
describe('Book e2e test', () => {
  ...
  it('should load Books', async () => {
    ...
    expect(await bookComponentsPage.getTitle()).to.eq('myCrMv1App.book.home.title');
  ...
  it('should load create Book page', async () => {
    ...
    expect(await bookUpdatePage.getPageTitle()).to.eq('myCrMv1App.book.home.createOrEditLabel');
  ...
  it('should delete last Book', async () => {
    ...
    expect(await bookDeleteDialog.getDialogTitle()).to.eq('myCrMv1App.book.delete.question');
